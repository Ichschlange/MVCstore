...
<body>
  ...
  //  print($data);
	foreach($data as $row)
	{
        ...
        print "<form id='form1' name='form1' method='post' action='http://localhost/tariff/index'>";
        print "<span>Название ".$row[2]."</span><br>";
        print "<span>Цена ".$row[1]."</span><br>";
        print "<span>Описание ".$row[3]."</span><br>";
    ...
    <div class="sortFilter">
        <form action="http://localhost/tariff/index" method="post">
        <div class="sort">
